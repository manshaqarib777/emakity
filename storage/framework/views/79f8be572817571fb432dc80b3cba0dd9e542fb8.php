                ...
                <div class="card-body login-card-body">
                    ...
                    <form action="<?php echo e(url('/register')); ?>" method="post">
                        ...
                        <div class="input-group mb-3">
                            <input value="<?php echo e(old('name')); ?>" type="name"
                                class="form-control <?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" name="name"
                                placeholder="<?php echo e(__('auth.name')); ?>" aria-label="<?php echo e(__('auth.name')); ?>">
                        ...
                        <div class="input-group mb-3">
                            <input value="<?php echo e(old('password_confirmation')); ?>" type="password"
                                ...
                                name="password_confirmation" placeholder="<?php echo e(__('auth.password_confirmation')); ?>"
                                aria-label="<?php echo e(__('auth.password_confirmation')); ?>">
                        ...
                        <div class="row mb-2">
                            ...
                            <!-- /.col -->
                            <div class="col-5">
                                <button type="submit" class="submit"><?php echo e(__('auth.register')); ?></button>
                            </div>
                            <!-- /.col -->
                        </div>
                    ...
                    <p class="mb-0 text-center">
                        <a href="<?php echo e(url('/login')); ?>" class="text-center"><?php echo e(__('auth.already_member')); ?></a>
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('authentication.layouts.auth.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/food/resources/views/authentication/auth/register.blade.php ENDPATH**/ ?>