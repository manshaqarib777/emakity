...
<aside class="main-sidebar sidebar-<?php echo e(setting('theme_contrast')); ?>-<?php echo e(setting('theme_color')); ?> elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo e(url('/')); ?>" class="brand-link <?php echo e(setting('logo_bg_color','bg-white')); ?>">
...
<?php /**PATH /var/www/html/food/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>