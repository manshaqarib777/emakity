            ...
            <div class="row">
                <div class="col-12">
                    <ul class="page-breadcrumb__menu">
                        <li class="page-breadcrumb__nav"><a href="<?php echo e(url('/')); ?>">Home</a></li>
                        <li class="page-breadcrumb__nav active"><?php echo e($market->name); ?></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="tab-content tab-animate-zoom">
                            <div class="tab-pane show active shop-grid" id="sort-grid">
                                <div class="row">
                                    ...
                                    <?php $__currentLoopData = $market->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="product__box product__default--single text-center">
                                                ...
                                                <div class="product__content m-t-20">
                                                    ...
                                                    <div class="product__price m-t-5">
                                                        <span
                                                            class="product__price"><?php echo e($product->market->currency->symbol); ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/food/resources/views/frontend/market.blade.php ENDPATH**/ ?>