                        ...
                        <div class="card-header">
                            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                                ...
                                <div class="ml-auto d-inline-flex">
                                    <li class="nav-item">
                                        <a class="nav-link pt-1" href="<?php echo route('markets.create'); ?>"><i class="fa fa-check-o"></i> <?php echo e(trans('lang.app_setting_become_store_owner')); ?></a>
                                    </li>
                                </div>
                                <?php endif; ?>
                            </ul>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/food/resources/views/settings/users/profile.blade.php ENDPATH**/ ?>