    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo url('settings/payment/razorpay'); ?>"><i class="fa fa-envelope-o mr-2"></i><?php echo e(trans('lang.app_setting_razorpay')); ?><?php if(setting('enable_razorpay',false)): ?><span class="badge ml-2 badge-success"><?php echo e(trans('lang.active')); ?></span><?php endif; ?>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="row">
                ...
                <!-- 'Boolean enable_facebook Field' -->
                    <div class="form-group row col-12">
                        <?php echo Form::label('enable_razorpay', trans('lang.app_setting_enable_razorpay'),['class' => 'col-3 control-label text-right']); ?>

                        <div class="checkbox icheck">
                            <label class="w-100 ml-2 form-check-inline">
                                <?php echo Form::hidden('enable_razorpay', null); ?>

                                <?php echo Form::checkbox('enable_razorpay', 1, setting('enable_razorpay', false)); ?>
                    ...
                    <div class="form-group row col-12">
                        <?php echo Form::label('razorpay_key', trans('lang.app_setting_razorpay_key'), ['class' => 'col-3 control-label text-right']); ?>
                    ...
                    <div class="form-group row col-12">
                        <?php echo Form::label('razorpay_secret', trans('lang.app_setting_razorpay_secret'), ['class' => 'col-3 control-label text-right']); ?>
...
<?php echo $__env->make('layouts.settings.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/food/resources/views/settings/payment/razorpay.blade.php ENDPATH**/ ?>