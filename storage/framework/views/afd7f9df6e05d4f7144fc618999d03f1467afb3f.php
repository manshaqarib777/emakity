...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/')); ?>frontend/assets/css/vendor/fontawesome.css">
    <link rel="stylesheet" href="<?php echo e(asset('/')); ?>frontend/assets/css/vendor/plaza-icon.css">
    <link rel="stylesheet" href="<?php echo e(asset('/')); ?>frontend/assets/css/vendor/bootstrap.min.css">

    <!-- Plugin CSS Files -->
    <link rel="stylesheet" href="<?php echo e(asset('/')); ?>frontend/assets/css/plugin/slick.css">
    <link rel="stylesheet" href="<?php echo e(asset('/')); ?>frontend/assets/css/plugin/material-scrolltop.css">
    <link rel="stylesheet" href="<?php echo e(asset('/')); ?>frontend/assets/css/plugin/price_range_style.css">
    <link rel="stylesheet" href="<?php echo e(asset('/')); ?>frontend/assets/css/plugin/in-number.css">
    <link rel="stylesheet" href="<?php echo e(asset('/')); ?>frontend/assets/css/plugin/venobox.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('/')); ?>frontend/assets/css/plugin/jquery.lineProgressbar.css">
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-between align-items-center">
                            ...
                            <div class="header__logo">
                                <a href="<?php echo e(url('/')); ?>" class="header__logo-link img-responsive">
                                    <img class="header__logo-img img-fluid" src="<?php echo e($app_logo); ?>" alt="">
                                </a>
                            </div> <!-- End Logo -->
                            <!-- Start Header Menu -->
                                ...
                                <nav>
                                    <ul class="header__nav">
                                        ...
                                        <li class="header__nav-item pos-relative">
                                            <a href="<?php echo e(url('/')); ?>" class="header__nav-link">Home</a>
                                            ...
                                            <ul class="mega-menu pos-absolute">
                                                <li class="mega-menu__box">
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            <li class="mega-menu__list"><a
                                                                    ...
                                                                    class="mega-menu__link">Grid Left Sidebar</a>
                                                            </li>
                                                            <li class="mega-menu__list pos-relative">
                                                                <a href="shop-sidebar-grid-right.html"
                                                                    class="mega-menu__link">Grid Right Sidebar</a>
                                                                <span class="menu-label menu-label--red">New</span>
                                                            </li>
                                                            <li class="mega-menu__list"><a
                                                                    href="shop-sidebar-full-width.html"
                                                                    class="mega-menu__link">Full Width</a></li>
                                                            <li class="mega-menu__list"><a
                                                                    href="shop-sidebar-left-list-view.html"
                                                                    class="mega-menu__link">List Left Sidebar</a>
                                                            </li>
                                                            <li class="mega-menu__list"><a
                                                                    href="shop-sidebar-right-list-view.html"
                                                                    class="mega-menu__link">List Right Sidebar</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <!--Single Megamenu Item Menu-->
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            <li class="mega-menu__list"><a href="cart.html"
                                                                    class="mega-menu__link">Cart</a></li>
                                                            <li class="mega-menu__list"><a href="checkout.html"
                                                                    class="mega-menu__link">Checkout</a></li>
                                                            <li class="mega-menu__list"><a href="compare.html"
                                                                    class="mega-menu__link">Compare</a></li>
                                                            <li class="mega-menu__list pos-relative">
                                                                <a href="empty-cart.html" class="mega-menu__link">Empty
                                                                    Cart</a>
                                                            ...
                                                            <li class="mega-menu__list"><a href="<?php echo e(route('login')); ?>"
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            <li class="mega-menu__list"><a
                                                                    ...
                                                                    class="mega-menu__link">Simple</a></li>
                                                            <li class="mega-menu__list"><a
                                                                    href="product-single-affiliate.html"
                                                                    class="mega-menu__link">Affiliate</a></li>
                                                            <li class="mega-menu__list pos-relative">
                                                                <a href="product-single-group.html"
                                                                    class="mega-menu__link">Grouped</a>
                                                                <span class="menu-label menu-label--red">New</span>
                                                            </li>
                                                            <li class="mega-menu__list"><a
                                                                    href="product-single-variable.html"
                                                                    class="mega-menu__link">Variable</a></li>
                                                            <li class="mega-menu__list"><a
                                                                    href="product-single-tab-left.html"
                                                                    class="mega-menu__link">Left Tab</a></li>
                                                            <li class="mega-menu__list"><a
                                                                    href="product-single-tab-right.html"
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            <li class="mega-menu__list"><a
                                                                    href="product-single-slider.html"
                                                                    class="mega-menu__link">Single Slider</a></li>
                                                            <li class="mega-menu__list"><a
                                                                    href="product-single-gallery-left.html"
                                                                    class="mega-menu__link">Gallery Left</a></li>
                                                            <li class="mega-menu__list"><a
                                                                    href="product-single-gallery-right.html"
                                                                    class="mega-menu__link">Gallery Right</a></li>
                                                            <li class="mega-menu__list"><a
                                                                    href="product-single-sticky-left.html"
                                                                    class="mega-menu__link">Sticky Left</a></li>
                                                            <li class="mega-menu__list pos-relative">
                                                                <a href="product-single-sticky-right.html"
                                                                    class="mega-menu__link">Sticky Right</a>
                                                                <span class="menu-label menu-label--blue">New</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            ...
                                                            <li class="mega-menu__banner ">
                                                                <a href="product-single-default.html"
                                                                    ...
                                                                    <img src="<?php echo e(asset('/')); ?>frontend/assets/img/banner/menu-banner.jpg"
                                                                        alt=""
                                        ...
                                        <!--Start Single Nav link-->
                                        <li class="header__nav-item pos-relative">
                                            <a href="#" class="header__nav-link">Custom Block <i
                                                    class="fal fa-chevron-down"></i></a>
                                            <!-- Megamenu Menu-->
                                            <ul class="mega-menu pos-absolute">
                                                <li class="mega-menu__box">
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            <li>
                                                                <p>Shop Women Is Clothing And Accessories And Get
                                                                    Inspired By The Latest Fashion Trends.</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <!--Single Megamenu Item Menu-->
                                                    ...
                                                    <div class="mega-menu__item-box">
                                                        ...
                                                        <ul class="mega-menu__item">
                                                            <li>
                                                                <p>A New Flattering Style With All The Comfort Of
                                                                    Our Linen.</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <li class="mega-menu__banner m-t-30">
                                                    <a href="product-single-default.html"
                                                        class="mega-menu__banner-link">
                                                        <img src="<?php echo e(asset('/')); ?>frontend/assets/img/banner/menu-banner-2.png"
                                                            alt=""
                                        ...
                                        <!--Start Single Nav link-->
                                        <li class="header__nav-item pos-relative">
                                            <a href="#" class="header__nav-link">Blog<i
                                                    class="fal fa-chevron-down"></i></a>
                                                ...
                                                <li class="dropdown__list">
                                                    ...
                                                    <ul class="dropdown__submenu pos-absolute">
                                                        <li class="dropdown__submenu-list"><a
                                                                ...
                                                                class="dropdown__submenu-link"> Blog List Left
                                                                Sidebar</a></li>
                                                        <li class="dropdown__submenu-list"><a
                                                                href="blog-list-sidebar-right.html"
                                                                class="dropdown__submenu-link"> Blog List Right
                                                                Sidebar</a></li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown__list">
                                        ...
                                        <!--Start Single Nav link-->
                                        <li class="header__nav-item pos-relative">
                                            <a href="#" class="header__nav-link">Pages <i
                                                    class="fal fa-chevron-down"></i></a>
                                            <span class="menu-label menu-label--blue">New</span>
                                            <!--Single Dropdown Menu-->
                                            <ul class="dropdown__menu pos-absolute">
                                                <li class="dropdown__list"><a href="about.html"
                                                        class="dropdown__link">About Us</a></li>
                                                <li class="dropdown__list pos-relative">
                                                    <a href="frequently-questions.html"
                                                        class="dropdown__link">Frequently Questions</a>
                                                    <span class="menu-label menu-label--blue">New</span>
                                                </li>
                                                <li class="dropdown__list"><a href="privacy-policy.html"
                                                        class="dropdown__link">Privacy Policy</a></li>
                                                <li class="dropdown__list"><a href="404.html" class="dropdown__link">404
                                                        Page</a></li>
                                            </ul>
                                            <!--Single Dropdown Menu-->
                                        </li> <!-- End Single Nav link-->
                            ...
                            <ul class="header__user-action-icon">
                                ...
                                <?php if(auth()->guard()->check()): ?>
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('cart')); ?>">
                                            ...
                                            <span class="wishlist-item-count pos-absolute"><?php echo e($app_carts); ?></span>
                                        </a>
                                ...
                                <!-- Start Header Add Cart Box -->
                                <li>
                                    <a href="<?php echo e(route('cart')); ?>" class="offcanvas-toggle">
                                        <i class="icon-shopping-cart"></i>
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-xl-3 col-lg-3">
                            <div class="header-menu-vertical pos-relative">
                                <h4 class="menu-title link--icon-left"><i class="far fa-align-left"></i>CATEGORIES
                                </h4>
                                <ul class="menu-content pos-absolute">
                                    <?php $__currentLoopData = $app_categories->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="menu-item"><a href="#"><?php echo e($category->name); ?></a></li>
                        ...
                        <ul class="header__mobile--leftside d-flex align-items-center justify-content-start">
                            <li>
                                <div class="header__mobile-logo">
                                    <a href="<?php echo e(url('/')); ?>" class="header__mobile-logo-link">
                                        <img src="<?php echo e($app_logo); ?>" alt="" class="header__mobile-logo-img">
                                    </a>
                                </div>
                            </li>
                        </ul>
            ...
            <div class="offcanvas-inner">
                <ul class="user-set-role d-flex justify-content-between m-tb-15">
                    <li class="user-currency pos-relative">
                        ...
                        <ul class="expand-dropdown-menu dropdown-menu">
                            <li><a href="#"><img src="<?php echo e(asset('/')); ?>frontend/assets/img/icon/flag/icon_usa.png"
                                        alt="">English</a></li>
                        ...
                        <div class="offcanvas-add-cart__img-box pos-relative">
                            <a href="product-single-default.html"
                                class="offcanvas-add-cart__img-link img-responsive"><img
                                    src="<?php echo e(asset('/')); ?>frontend/assets/img/product/size-small/product-home-1-img-1.jpg"
                ...
                <li class="offcanvas-add-cart__list pos-relative d-flex align-items-center justify-content-between">
                    <div class="offcanvas-add-cart__content d-flex  align-items-start m-r-10">
                        <div class="offcanvas-add-cart__img-box pos-relative">
                            <a href="product-single-default.html"
                                class="offcanvas-add-cart__img-link img-responsive"><img
                                    src="<?php echo e(asset('/')); ?>frontend/assets/img/product/size-small/product-home-1-img-2.jpg"
                                    alt="" class="add-cart__img"></a>
                            <span class="offcanvas-add-cart__item-count pos-absolute">2x</span>
                        </div>
                        <div class="offcanvas-add-cart__detail">
                    ...
                    <div class="col-lg-4 col-md-5">
                        <div class="footer__about">
                            <div class="footer__logo">
                                <a href="<?php echo e(url('/')); ?>" class="footer__logo-link">
                                    <img src="<?php echo e($app_logo); ?>" alt="" class="footer__logo-img">
                                </a>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6 col-12">
                        ...
                        <div class="footer__copyright-text">
                            <p>Copyright &copy; <a href="<?php echo e(url('/')); ?>">Food Company</a>. All Rights Reserved</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="footer__payment">
                            <a href="#" class="footer__payment-link">
                                <img src="<?php echo e(asset('/')); ?>frontend/assets/img/company-logo/payment.png" alt=""
    ...
    <?php echo $__env->make('frontend.layouts.media_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <!-- Vendor JS Files -->
    <script src="<?php echo e(asset('/')); ?>frontend/assets/js/vendor/jquery-3.5.1.min.js"></script>
    <script src="<?php echo e(asset('/')); ?>frontend/assets/js/vendor/modernizr-3.7.1.min.js"></script>
    ...
    <!-- Plugins JS Files -->
    <script src="<?php echo e(asset('/')); ?>frontend/assets/js/plugin/slick.min.js"></script>
    <script src="<?php echo e(asset('/')); ?>frontend/assets/js/plugin/jquery.countdown.min.js"></script>
    <script src="<?php echo e(asset('/')); ?>frontend/assets/js/plugin/material-scrolltop.js"></script>
    <script src="<?php echo e(asset('/')); ?>frontend/assets/js/plugin/price_range_script.js"></script>
    <script src="<?php echo e(asset('/')); ?>frontend/assets/js/plugin/in-number.js"></script>
    <script src="<?php echo e(asset('/')); ?>frontend/assets/js/plugin/jquery.elevateZoom-3.0.8.min.js"></script>
    <script src="<?php echo e(asset('/')); ?>frontend/assets/js/plugin/venobox.min.js"></script>
    <script src="<?php echo e(asset('/')); ?>frontend/assets/js/plugin/jquery.waypoints.js"></script>
    <script src="<?php echo e(asset('/')); ?>frontend/assets/js/plugin/jquery.lineProgressbar.js"></script>
    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <!-- <script src="<?php echo e(asset('/')); ?>frontend/assets/js/vendor/vendor.min.js"></script>
    <script src="<?php echo e(asset('/')); ?>frontend/assets/js/plugin/plugins.min.js"></script> -->
...
<?php /**PATH /var/www/html/food/resources/views/frontend/layouts/app.blade.php ENDPATH**/ ?>