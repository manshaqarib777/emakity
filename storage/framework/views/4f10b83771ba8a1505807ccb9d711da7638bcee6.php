...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><?php echo e(trans('lang.option_group_plural')); ?> <small><?php echo e(trans('lang.option_group_desc')); ?></small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="<?php echo route('optionGroups.index'); ?>"><?php echo e(trans('lang.option_group_plural')); ?></a>
          </li>
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo route('optionGroups.create'); ?>"><i class="fa fa-plus mr-2"></i><?php echo e(trans('lang.option_group_create')); ?></a>
        </li>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/food/resources/views/option_groups/index.blade.php ENDPATH**/ ?>