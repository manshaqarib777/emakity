...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        {!! Form::label('in_stock', trans("lang.product_in_stock"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::number('in_stock', null,  ['class' => 'form-control','placeholder'=>  trans("lang.product_in_stock_placeholder"),'step'=>"any", 'min'=>"0"]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.product_in_stock_help") }}
            </div>
        </div>
    </div>
