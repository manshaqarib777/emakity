...
<div class="form-group row ">
  ...
  <div class="col-9">
    {!! Form::textarea('description', null, ['class' => 'form-control','placeholder'=>
     trans("lang.testimonial_description_placeholder")  ]) !!}
    ...
    var dz_var15866134631720934041ble = $(".dropzone.image").dropzone({
        ...
        removedfile: function (file) {
            dzRemoveFile(
                ...
                'image', '{!! isset($testimonial) ? $testimonial->id : 0 !!}', '{!! url("uplaods/clear") !!}', '{!! csrf_token() !!}'
            );
        }
    });
...
<div class="form-group col-12 text-right">
  <button type="submit" class="btn btn-{{setting('theme_color')}}" ><i class="fa fa-save"></i> {{trans('lang.save')}} {{trans('lang.testimonial')}}</button>
  <a href="{!! route('testimonials.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
